  ...
  \centersec{Specification}
    ...
    \subcentersec{Modules and Namespaces}
      ...
      \subsubsection*{modules}
        A \textit{module} is essentially a directory that can be compiled independantly
        and linked against. It is consists of all the source files in a given directory.
        It cannot have a main method and be used as a \textit{module}. A module is
        only one directory deep but can have infinite heirarchies of namespaces within it.
